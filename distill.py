...
def main(args):
    ...
    # eval_it_pool =[3000, 4000, 5000,11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000, 19000, 20000]

    eval_it_pool =[100,500,1000,2000,3000, 4000, 5000,11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000, 19000, 20000]
    ...
    if args.dataset == 'xrf55':
        ...
        num_classes = 27
        channel = 1
    print("num_classes: ", num_classes, "im_size: ", im_size, "channel: ", channel)
    ...
    wandb.init(sync_tensorboard=False,
            #    project="xrf_mtt_distill",
            #    project="widar_mtt",
               project="mmfi_mtt_distill",
    ...
    # expert_dir = '/home/wangtiantian/code/DATM-main/DATM-main/buffer/xrf55/xrf_mlp'
    ...
    for it in range(0, args.Iteration+1):
        ...
        if it in eval_it_pool and (save_this_it or it % 1000 == 0):
            with torch.no_grad():
                ...
                save_dir = os.path.join(".", "logged_file","mtt2" ,args.dataset, wandb.run.name)
                ...
                if args.ipc < 0 or args.force_save:
